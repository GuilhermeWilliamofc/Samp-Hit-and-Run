...
1. Baixe o [servidor SA-MP 0.3.7](https://www.sa-mp.mp/create-server/) para o seu sistema operacional.
2. Copie `Hit_And_Run.amx` para a pasta `gamemodes/` do servidor.
